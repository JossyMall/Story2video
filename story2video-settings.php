...
function story2video_settings_page() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            <?php settings_fields('story2video_settings_group'); ?>
            <?php do_settings_sections('story2video_settings_group'); ?>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row">FFmpeg Path</th>
                    <td>
                        <input type="text" name="story2video_ffmpeg_path" value="<?php echo esc_attr(get_option('story2video_ffmpeg_path', 'ffmpeg')); ?>" />
                        <button type="button" id="test-ffmpeg-path" class="button">Test FFmpeg Path</button>
...
add_action('admin_init', 'story2video_settings_init');

function story2video_settings_init() {
